...
export function mapPendingMatch(item: ApiPendingMatch): PendingShipment {
  ...
  return {
    ...
    cargoCategories: item.cargo_categories ?? [],
    totalQty: item.total_qty ?? null,
    qtyUnit: item.qty_unit ?? null,
    quantityLabel: item.quantity_label ?? null,
...
export function mapPendingMatchDetail(item: ApiPendingMatchDetail): PendingMatchDetail {
  ...
  const snapshot: PendingMatchSnapshot | null = snap
    ? {
        ...
        cargoCategories: snap.cargo_categories ?? base.cargoCategories ?? [],
        totalQty: snap.total_qty ?? base.totalQty ?? null,
        qtyUnit: snap.qty_unit ?? base.qtyUnit ?? null,
        quantityLabel: snap.quantity_label ?? base.quantityLabel ?? null,
