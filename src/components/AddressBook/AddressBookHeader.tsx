...
type Props = Pick<AddressBookState, 'lang' | 't' | 'exportExcel' | 'exporting' | 'openCreateModal'>;

export const AddressBookHeader: React.FC<Props> = ({ lang, t, exportExcel, exporting, openCreateModal }) => (
