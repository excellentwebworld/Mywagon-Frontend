/**
 * auditLogData.js — 50 audit log entries across 17 categories.
 * Covers: auth, profile, org, users, kyc, policies, shipments, orders,
 * loads, fleet, priceLists, partners, masterData, docs, billing, settings, export.
 */
...
export const AUDIT_CATEGORIES = [
  ...
  { key: 'policies', icon: '📜', labelKey: 'compliance.audit.cat.policies' },
  { key: 'shipments', icon: '📦', labelKey: 'compliance.audit.cat.shipments' },
  { key: 'orders', icon: '📋', labelKey: 'compliance.audit.cat.orders' },
  { key: 'loads', icon: '🚚', labelKey: 'compliance.audit.cat.loads' },
  { key: 'fleet', icon: '🚛', labelKey: 'compliance.audit.cat.fleet' },
  { key: 'priceLists', icon: '💰', labelKey: 'compliance.audit.cat.priceLists' },
  { key: 'partners', icon: '🤝', labelKey: 'compliance.audit.cat.partners' },
  { key: 'masterData', icon: '🗄️', labelKey: 'compliance.audit.cat.masterData' },
  { key: 'documents', icon: '📄', labelKey: 'compliance.audit.cat.documents' },
  { key: 'billing', icon: '💳', labelKey: 'compliance.audit.cat.billing' },
  { key: 'settings', icon: '⚙️', labelKey: 'compliance.audit.cat.settings' },
...
export const AUDIT_LOG_ENTRIES = [
  ...
  { id: 'A002', ts: d(1), actor: A.pavlos, category: 'fleet', action: 'Vehicle assigned', severity: 'info', target: 'DRV-005 (Νίκος Κ.) → TRK-001 (Volvo FH)', details: 'Driver assigned to truck for route ATH-SKG.', changes: null },
  ...
  { id: 'A009', ts: d(6), actor: A.andreas, category: 'masterData', action: 'Address created', severity: 'info', target: 'Piraeus Port Terminal B', details: 'New warehouse address added to Address Book.', changes: null },
  { id: 'A010', ts: d(7), actor: A.pavlos, category: 'export', action: 'CSV exported', severity: 'info', target: 'Orders module', details: 'Exported 148 orders with all columns.', changes: null },
  ...
  { id: 'A013', ts: d(23), actor: A.paulos, category: 'loads', action: 'Load created', severity: 'info', target: 'LD-0089 · Ioannina → Athens', details: '2 orders consolidated, 18 pallets.', changes: null },
  ...
  { id: 'A015', ts: d(25), actor: A.pavlos, category: 'policies', action: 'Policy accepted', severity: 'info', target: 'Privacy Policy v1.2', details: 'Accepted via Settings page.', changes: null },
  ...
  { id: 'A017', ts: d(27), actor: A.pavlos, category: 'fleet', action: 'Driver added', severity: 'info', target: 'DRV-013 Αλέξανδρος Π.', details: 'New driver created with B+CE license.', changes: null },
  ...
  { id: 'A020', ts: d(55), actor: A.pavlos, category: 'settings', action: 'Integration configured', severity: 'info', target: 'ERP Sync · SAP Business One', details: 'API key updated, sync interval set to 15min.', changes: null },
  ...
  { id: 'A023', ts: d(70), actor: A.paulos, category: 'fleet', action: 'Driver suspended', severity: 'warning', target: 'DRV-008 Κ. Αναγνώστου', details: 'License expired, pending renewal.', changes: null },
  ...
  { id: 'A025', ts: d(75), actor: A.andreas, category: 'documents', action: 'Document uploaded', severity: 'info', target: 'CMR_SHP4510.pdf', details: 'Uploaded to shipment SHP-4510.', changes: null },
  ...
  { id: 'A028', ts: d(90), actor: A.maria, category: 'export', action: 'CSV exported', severity: 'info', target: 'Price Lists module', details: 'Exported 42 lanes with profitability data.', changes: null },
  ...
  { id: 'A033', ts: d(160), actor: A.paulos, category: 'loads', action: 'Delivery confirmed', severity: 'info', target: 'LD-0082 · Athens → Patras', details: 'POD uploaded, delivery confirmed at 14:30.', changes: null },
  { id: 'A034', ts: d(170), actor: A.pavlos, category: 'fleet', action: 'Vehicle added', severity: 'info', target: 'TRK-008 Scania R450', details: 'New truck registered, plate ΙΩΑ-8842.', changes: null },
  ...
  { id: 'A037', ts: d(220), actor: A.pavlos, category: 'authentication', action: 'Password changed', severity: 'info', target: 'pavlos@vikos.com', details: 'Password changed successfully.', changes: null },
  { id: 'A038', ts: d(240), actor: A.pavlos, category: 'authentication', action: 'MFA enabled', severity: 'info', target: 'pavlos@vikos.com', details: 'Authenticator app configured.', changes: null },
  { id: 'A039', ts: d(260), actor: A.pavlos, category: 'policies', action: 'DPA accepted', severity: 'info', target: 'Data Processing Agreement v1.1', details: 'Accepted on behalf of organization.', changes: null },
  { id: 'A040', ts: d(280), actor: A.pavlos, category: 'policies', action: 'Marketing consent changed', severity: 'info', target: 'Marketing Communications', details: 'Opted out of marketing emails.', changes: [{ field: 'Consent', from: 'Enabled', to: 'Disabled' }] },
  { id: 'A041', ts: d(300), actor: A.pavlos, category: 'settings', action: 'Notification preference', severity: 'info', target: 'Email notifications', details: 'Disabled marketing email notifications.', changes: null },
  ...
  { id: 'A044', ts: d(360), actor: A.pavlos, category: 'masterData', action: 'Product edited', severity: 'info', target: 'SKU-0042 Vikos 1.5L', details: 'Updated weight and dimensions.', changes: [{ field: 'Weight', from: '1.5kg', to: '1.55kg' }] },
