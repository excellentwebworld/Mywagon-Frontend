...
export const VEHICLE_STATUS_COLORS = { available:{bg:'#D1FAE5',fg:'#059669',bd:'#A7F3D0'}, assigned:{bg:'#DBEAFE',fg:'#2563EB',bd:'#BFDBFE'}, paired:{bg:'#EDE9FE',fg:'#9B51E0',bd:'#C4B5FD'}, maintenance:{bg:'#FEF3C7',fg:'#92400E',bd:'#FDE68A'}, decommissioned:{bg:'#F3F4F6',fg:'#6B7280',bd:'#D1D5DB'} };
