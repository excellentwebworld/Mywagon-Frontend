...
export const CONNECTORS = [
  // Connected
  { id: 'softone', name: 'Softone by Entersoft', category: 'erp', icon: '⚡', status: 'connected', featured: true, region: 'GR', syncDirection: 'bidirectional', lastSync: '2026-05-09T07:15:00Z', errorCount: 0, dataTypes: ['orders', 'products', 'customers', 'invoices'], description: 'Full ERP integration for orders, products, customers and invoicing. Bidirectional sync keeps data consistent across systems.' },
  { id: 'frotcom', name: 'Frotcom', category: 'fleet', icon: '📡', status: 'connected', featured: false, region: 'GR', syncDirection: 'inbound', lastSync: '2026-05-09T08:45:00Z', errorCount: 0, dataTypes: ['gps', 'mileage', 'fuel'], description: 'Real-time GPS tracking, mileage reporting, and fuel consumption data from your fleet.' },
  { id: 'mydata', name: 'myDATA / AADE', category: 'accounting', icon: '🇬🇷', status: 'error', featured: true, region: 'GR', syncDirection: 'outbound', lastSync: '2026-05-08T10:00:00Z', errorCount: 3, dataTypes: ['invoices'], description: 'Official Greek tax authority e-invoicing. Automatic submission of invoices and credit notes to AADE.' },

  // Not connected
  { id: 'sap_b1', name: 'SAP Business One', category: 'erp', icon: '🔷', status: 'not_connected', region: null, dataTypes: ['orders', 'products', 'customers', 'invoices'], description: 'Enterprise-grade ERP with comprehensive supply chain management and financial reporting.' },
  { id: 'dynamics_bc', name: 'Dynamics 365 BC', category: 'erp', icon: '🟦', status: 'not_connected', region: null, dataTypes: ['orders', 'products', 'customers'], description: 'Microsoft Business Central for small-to-mid-size businesses. Orders, inventory, and CRM.' },
