...
function buildMilestones(shipment: Shipment): MilestoneItem[] {
  ...
  const labels: Record<(typeof MILESTONE_KEYS)[number], { en: string; el: string; time?: string; badge?: string }> = {
    created: { en: 'Created', el: 'Δημιουργία', time: '19/02 10:53' },
    privateAccepted: { en: 'Private Accepted', el: 'Αποδοχή ιδιωτικής', time: '19/02 12:12' },
    carrier: {
    ...
    startTrip: { en: 'Start Trip', el: 'Έναρξη διαδρομής', time: '19/02 14:13' },
    arrival: { en: `Arrival ${shipment.origin}`, el: 'Άφιξη', time: '20/02 01:40' },
    pickup: { en: `Pickup ${shipment.origin}`, el: 'Pickup', time: '20/02 01:40' },
    pickup2: { en: `Pickup ${shipment.origin} #2`, el: 'Pickup #2', time: '20/02 02:56' },
  ...
  return {
    ...
    documents: [
      ...
      },
      {
        ...
        name: 'CMR',
        status: 'ok',
        subtitle: 'Uploaded 19/02 14:15 by Dimitris N.',
      ...
      },
      {
        ...
        name: 'BOL',
        status: 'ok',
        subtitle: 'Uploaded 18/02 08:30 by System',
        actions: ['Download'],
      },
      {
        id: 'd4',
    ...
    incidents: [
      {
        ...
        meta: 'Low severity · Resolved 20/02 03:10',
        severity: 'low',
        resolved: true,
      },
    ],
