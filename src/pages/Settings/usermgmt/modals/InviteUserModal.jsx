/**
 * InviteUserModal — invite or edit user via the same popup form.
 * Invite: POST settings/users/invite
 * Edit:   PUT  settings/users/:id
 */
    ...
    <div className="fixed inset-0 flex items-center justify-center p-4" style={{ zIndex: 300 }}>
      ...
      >
        ...
        <div className="px-6 py-5 space-y-4 max-h-[70vh] overflow-y-auto">
          ...
          <Field label={t('userMgmt.invite.email')} required={!isEdit} error={errors.email}>
            <input
              type="email"
              value={form.email}
